...
function createMonitorCard(monitor) {
    ...
    card.innerHTML = `
        <div class="monitor-header">
            ...
            <div>
                <div class="monitor-title">${monitor.name}</div>
        ...
        <div class="monitor-details">
            <div class="detail-item">
                ...
                <span class="detail-value">${monitor.description}</span>
            </div>
            <div class="detail-item">
            ...
            <div class="detail-item">
                ...
                <span class="detail-value">${monitor.transform}</span>
            </div>
            <div class="detail-item">
                <span class="detail-label">Active Workspace</span>
                <span class="detail-value">${monitor.active_workspace_name} (#${monitor.active_workspace_id})</span>
            </div>
        </div>
    `;
